  ...
  return (
    <>
      ...
      <div className="pitch-sheet-root relative min-h-screen overflow-x-hidden bg-slate-50/50">
        ...
        <div className="relative overflow-hidden border-b border-teal-900/10 bg-gradient-to-br from-teal-700 via-teal-600 to-teal-500">
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-lime-400/20 blur-[90px]" />
            <div className="absolute -bottom-24 left-1/3 h-72 w-72 rounded-full bg-white/10 blur-[100px]" />
          </div>

          <div className="relative z-10 mx-auto max-w-[96rem] px-4 py-10 md:px-8 md:py-14">
            <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
              <div className="flex items-start gap-4">
                <div className="hidden h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-white/95 p-2 shadow-lg sm:flex">
                  <img
                    src="/logo.png"
                    alt="Fidem logo"
                ...
                <div>
                  <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-white/30 bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-widest text-lime-100 backdrop-blur">
                    <Sparkles className="h-3.5 w-3.5 text-lime-200" /> Curated
                    Pitch Folder
                  </div>

                  {brandName ? (
                    <p className="mb-1 text-sm font-semibold uppercase tracking-wide text-lime-100">
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {valueProps.map((prop) => (
                  <div
                    key={prop.title}
                    className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md"
                  >
                    <span
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
              {rows.map((row) => {
                ...
                return (
                  <div
                    key={row._id}
                    className="group flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-teal-200 hover:shadow-md"
                  >
