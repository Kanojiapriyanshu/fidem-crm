...
function adminInviteEmailTemplate(opts) {
  ...
  const subject = "You're invited to Fidem Admin";

  const headline = "You're invited";
  const subText = `You have been invited to Fidem Admin as <b>${displayRole}</b>. Click the button below to set your password and activate your account.`;

  const text = `You have been invited to Fidem Admin as ${displayRole}.
            ...
            <table role="presentation" width="620" cellspacing="0" cellpadding="0"
              ...
              <tr>
                <td style="padding:18px 22px 10px 22px;font-family:Arial,Helvetica,sans-serif;">
                  <div style="font-size:16px;font-weight:700;color:#111827;">Fidem</div>
                </td>
              </tr>
              <tr>
